        ...
        <Reveal>
          <div className="prose">
            <p>
              ...
              cutting-edge courses, we are committed to driving sustainable
            ...
            <div>
              ...
              <div className="prose">
                <p>
                  ...
                  within the maritime industry by delivering high-quality
                  training and educational programs, both online and offline,
                  with a focus on carbon-neutral, zero-emission, and sustainable
                  fuels. Every course is carefully crafted to drive the
                  transformation of the maritime sector towards cleaner energy
                  solutions and sustainable practices, aligned with the 2050
                  Sustainable Development Goals.
                </p>
                <p>
                  Our vision is to become the leading international provider of
                  tailored skill development courses, empowering maritime
                  professionals to lead the adoption of clean fuels and
                  innovative technologies, driving a future of zero emissions and
      ...
      <section className="section wrap">
        <Reveal>
          ...
          <p className="section-lead">
            ...
            challenges and opportunities of the maritime industry, particularly
            in the realm of alternative fuels.
          </p>
        </Reveal>
          ...
          {[
            {
              ...
              body: "Our seasoned professionals bring extensive industry experience and specialized knowledge of alternative fuels and maritime sustainability, offering insights grounded in real-world expertise.",
            },
            {
              n: "02",
              title: "Cutting-edge Curriculum",
              body: "Our courses reflect the latest advancements in LNG, hydrogen, and emerging alternative fuel technologies. Designed to meet industry demands, our curriculum keeps you ahead of market trends and regulatory changes.",
            },
            {
              n: "03",
              title: "Flexible Learning Options",
              body: "We offer flexible course formats, including online and in-person learning options, making it easier for busy professionals to enhance their skills at their own pace.",
            },
            {
              n: "04",
              title: "Focus on Sustainability",
              body: "We are committed to driving decarbonization and a greener maritime industry through our specialized courses. Join us to lead the shift towards sustainable and innovative energy solutions.",
            },
          ].map((item, i) => (
            <Reveal key={item.n} delay={i * 80}>
              <article className="feature">
                <span className="feature-index">{item.n}</span>
                <h3>{item.title}</h3>
                <p>{item.body}</p>
              </article>
            </Reveal>
      ...
      <div className="wrap">
        <Reveal>
          <div className="cta-strip">
            ...
            <p>
              Reach the Beluga team in Dehradun for course enquiries and
              training guidance.
            </p>
